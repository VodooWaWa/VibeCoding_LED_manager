...
// Advertising data — service UUID only. Name in scan_rsp (31 bytes, fits full name).
...
// Scan response data — device name for identification
...
static esp_err_t handle_root(httpd_req_t *req) {
    ...
    RESP_SEND(en ? "Vibe Coding AI Status LED" : "Vibe Coding AI 状态指示灯");
    RESP_SEND(" <small style=\"color:var(--text-secondary);font-size:0.55em;font-weight:400\">v3.5</small></h1>");
